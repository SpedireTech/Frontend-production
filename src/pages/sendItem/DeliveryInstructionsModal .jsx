...
const DeliveryInstructionsModal = ({ isOpen, closeModal }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-lg overflow-hidden shadow-xl w-11/12 md:w-2/3 lg:w-1/2 mx-auto">
        <div className="p-6">
          <h2 className="text-2xl font-semibold mb-4">Delivery instructions</h2>
          <p className="mb-4 text-gray-600">
            Remember to share delivery details with your recipient and ensure
            your package meets the following requirements:
          </p>
          <ul className="mb-6 text-gray-700">
            ...
            <li className="flex items-start mb-2">
              <span className="text-green-500 mr-2">✔</span>
              Contains no prohibited items and does not exceed the local
              regulations' permitted goods value.
            </li>
          </ul>
          ...
          <div className="flex justify-center">
            <button
              onClick={closeModal}
              className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 cursor-pointer transition duration-300"
            >
              Okay
            </button>
          </div>
