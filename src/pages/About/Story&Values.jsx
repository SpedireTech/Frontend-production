...
const StoryValues = () => {
  return (
    ...
    <div className="flex p-20 flex-col items-center">
      <div className="w-full bg-button shadow-lg">
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 p-8 mt-8 md:mt-0 md:ml-8 text-left text-white">
            ...
            <p className="text-lg leading-relaxed">
              It all started at Semicolon, where we were united not just by our
              friendship. Our capstone project was looming, and we were
              determined to make it something meaningful, something that could
              address a pain point we all experienced, the chaotic, unreliable,
              and costly nature of traditional delivery services in Lagos. The
              turning point came one morning, fueled by the shared frustration
              of missing packages and the delays. This wasn't just our problem;
              it was a collective pain for countless residents and businesses.
              That's when the question that changed everything was posed: "What
              if deliveries could be made by people who are already on their
              way?"
            </p>
          </div>
        </div>
      ...
      <div className="w-full p-8">
        ...
        <p className="text-lg text-gray-700 text-center mb-8">
          We are committed to relentlessly exceed customer’s expectation through
          innovative technology solutions for logistics
        </p>
        <div className="flex flex-col rounded-lg bg-button pt-8 pb-8  md:flex-row justify-center gap-8">
