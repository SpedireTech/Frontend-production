  ...
  return (
    ...
    >
      ...
      >
        ...
        <FontAwesomeIcon
          icon={faSearch}
          style={{ fontSize: "24px", color: "gray", marginLeft: "15px" }}
        />

        {/* User Status Toggle */}
        <div
          style={{ display: "flex", alignItems: "center", marginLeft: "150px" }}
        >
        ...
        <div style={{ position: "relative", marginLeft: "12px" }}>
          <FontAwesomeIcon
            icon={faBell}
            style={{ fontSize: "24px", color: "#627891" }}
          />
          <span
            style={{
              position: "absolute",
      ...
      >
        ...
        >
          ...
          />
          <span
            style={{ marginLeft: "8px", color: "gray", marginRight: "8px" }}
          >
            Monthly
          </span>
          <FontAwesomeIcon
