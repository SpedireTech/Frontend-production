...
const TransactionHistory = () => {
	...
	return (
		<div className="mx-auto p-4 pb-0 mt-8 ml-2 h-[600px] md:h-[520px] flex flex-col flex-grow overflow-hidden">
			...
			<div className="overflow-auto  h-full">
				<table className="min-w-full h-full  text-[#4B4B4B]  rounded-lg">
					<thead>
						<tr>
